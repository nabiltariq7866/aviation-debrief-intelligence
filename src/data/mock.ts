...
const coreDebriefs:Debrief[]=[
  {
    id:'DBR-2048',type:'Post-Mission',missionType:'SAR',operationPeriod:'Day',title:'Northern Ridge Search Support',mission:'SAR-817',date:'2026-08-28',crew:['Capt. Maya Reynolds','FO Liam Hart'],aircraft:'AW139',location:'Northern Ridge Sector',
    ...
    whatWentWell:'Clear task sharing, stable CRM, effective go-around discussion.',improve:'Earlier weather reassessment and approach briefing update.',contributingFactors:['Weather','Crew workload','Communication'],selfEvaluation:'I maintained the approach profile safely but should have initiated the weather reassessment earlier.',teamEvaluation:'Crew coordination remained calm and effective as conditions changed.',
  ...
  {
    id:'DBR-2034',type:'Training Sortie',missionType:'Training',operationPeriod:'Night',title:'Instrument Approach Training',mission:'TRG-552',date:'2026-08-19',crew:['Capt. Daniel Cole','FO Sofia Grant'],aircraft:'AW139',location:'Coastal Training Area',
    rawNotes:'Weather deterioration was correctly identified, though briefing update happened late. Good decision to discontinue the approach.',whatWentWell:'Sound discontinue decision, calm crew communication.',improve:'Earlier briefing update after weather deterioration.',contributingFactors:['Weather','Visibility','Crew workload'],trainerCheckerNotes:'The crew identified the threat correctly; the training point is the timing of the briefing refresh.',
  ...
  {
    id:'DBR-1998',type:'Assessment Flight',missionType:'Training',operationPeriod:'Day',title:'Line Assessment — Sector Bravo',mission:'ASM-410',date:'2026-07-29',crew:['Capt. Maya Reynolds'],aircraft:'AW139',location:'Sector Bravo',
    rawNotes:'Strong handling and communication. Trainer noted a tendency to defer weather reassessment until workload was already increasing.',whatWentWell:'Handling, communication, checklist discipline.',improve:'Move weather reassessment earlier in the approach cycle.',contributingFactors:['Weather','Crew workload','Time pressure'],trainerCheckerNotes:'Assessment outcome remains trainer/checker-owned. The learning signal is earlier weather reassessment.',
  ...
  {
    id:'DBR-1972',type:'Post-Mission',missionType:'EMS',operationPeriod:'Night',title:'Offshore Medical Support Return',mission:'EMS-366',date:'2026-07-15',crew:['Capt. Noah Bennett','FO Liam Hart'],aircraft:'H175',location:'Offshore West',
    rawNotes:'Return sector encountered changing crosswind. Team handled it safely, but revised threat briefing happened after descent.',whatWentWell:'Stable communication and threat sharing.',improve:'Refresh threat briefing before descent when crosswind trend changes.',contributingFactors:['Weather','Communication','Crew workload'],
  ...
  {
    id:'DBR-2050',type:'Training Sortie',missionType:'Training',operationPeriod:'Night',title:'CRM Scenario Training',mission:'TRG-561',date:'2026-08-29',crew:['FO Sofia Grant','Trainer Alex Morgan'],aircraft:'H145',location:'Training Centre',
    rawNotes:'Strong challenge-and-response behavior. One task handover lacked explicit confirmation.',whatWentWell:'Good assertiveness and communication.',improve:'Use explicit closed-loop confirmation for task handovers.',contributingFactors:['Communication','Crew workload','Time pressure'],trainerCheckerNotes:'Closed-loop confirmation is the primary development point for this sortie.',
...
const backlogDebriefs:Debrief[]=Array.from({length:37},(_,index)=>{
  ...
  return {
    ...
    type,
    missionType,
    operationPeriod:index%2===0?'Day':'Night',
    title,
    ...
    contributingFactors:weatherTheme?['Weather','Visibility','Crew workload']:['Communication','Crew workload','Time pressure'],
